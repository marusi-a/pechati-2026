...
public/
  ...
  data/points.json                410 точек: координаты, условия печатей, глифы
...
точками. Загородные дни (Петергоф, Пушкин, Кронштадт, окраины) собраны по
зонам вручную и помечены в подзаголовке «на транспорте» — пешком их не пройти. Кластеры крупнее режутся пополам по длинной оси. Порядок внутри дня
